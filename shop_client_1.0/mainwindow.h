...
private:
    ...
    //modifyinf *p=new modifyinf;

//    int goods_locate=0;//锟斤拷锟杰ｏ拷锟斤拷品锟斤拷示锟斤拷锟捷匡拷锟斤拷锟斤拷
//    int goods_loc=0;//锟斤拷品锟斤拷示锟斤拷锟捷匡拷锟斤拷锟斤拷
//    int goods_target_locate=-1;
//    int search_loc=0;//锟斤拷锟斤拷锟斤拷锟斤拷品锟斤拷示锟斤拷锟捷匡拷锟斤拷锟斤拷
//    int species_loc[6]={0,0,0,0,0,0};//锟斤拷锟斤拷锟斤拷锟斤拷品锟斤拷锟斤拷示锟斤拷锟捷匡拷锟斤拷锟斤拷
