...
//        // judge=package_message(i,y,data,tcpClient,p->n,p->e);//无数字签名有加密
//        Message tempx=receive_message(tcpClient,p->n,p->d);//无数字签名有加密
//        qDebug()<<tempx.message_length;

////        QFile f("log.txt");
////        QTextStream txtOutput(&f);
////        txtOutput.setCodec("UTF-8");
////        if(f.open(QIODevice::WriteOnly | QIODevice::Text)){
////            txtOutput <<tempx.message_length <<endl;
////            f.close();
////        }
...
////        QDataStream in(&buf);
////        //QVector<QStandardItemModel> recv_pck;
////        QVector<QVector<QString>> recv_table;

////        in>>recv_table;
////        qDebug()<<recv_table[0][0];
