...
{
    const QString good_style="QLabel{background-color:rgb(255,255,255);border-radius: 10px;border:1px solid #a2a2a2;}";
    const QString img_style="QLabel{border-radius: 10px;border:1px solid #ffb70f;}";
    const QString as_btn_style="QPushButton{border-radius: 10px;background-color: rgb(255, 255, 255);border:1px solid #dfdfdf;}";
    const QString color_btn_style="QPushButton{background: qlineargradient(x1:0, y1:0, x2:1, y2:1,stop:0 rgba(255, 181, 79, 255), stop:1 rgba(255, 133, 111, 255));border-radius: 15px;color:#ffffff; font: bold 12px;font-family: 汉仪正圆-45W;}";
    ...
    ui->pushButton_purchase->setStyleSheet(color_btn_style);
    ui->pushButton_add_to_trolley->setStyleSheet(color_btn_style);
